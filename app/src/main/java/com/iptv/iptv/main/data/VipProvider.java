...
//        }
        ...
        JSONObject jsonObject = new VipProvider().fetchJSON(url);
        if (null == jsonObject) {
        ...
        EventBus.getDefault().post(new PageVipEvent(current < total, !next.equals("null") ? next : ""));
