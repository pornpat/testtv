...
public class SeriesChoiceAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static final int TYPE_NORMAL = 0;
    private static final int TYPE_FAV = 1;

    private final Context mContext;
    private final List<SeriesTrackItem> mValues;
    private final boolean isFav;

    public SeriesChoiceAdapter(Context context, List<SeriesTrackItem> items, boolean isFav) {
        mContext = context;
        mValues = items;
        this.isFav = isFav;
    }
